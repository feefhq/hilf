...
export function NothingDue({ nextDueAt, learnedCount, totalCount }: NothingDueProps) {
  return (
    <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900 flex flex-col items-center justify-center p-4 gap-6">
      ...
      <div className="mt-2 text-center">
        <p className="text-sm text-neutral-500 dark:text-neutral-400">
          <span className="font-semibold text-neutral-700 dark:text-neutral-300">{learnedCount}</span>
          {' '}of{' '}
          <span className="font-semibold text-neutral-700 dark:text-neutral-300">{totalCount}</span>
          {' '}words learned
        </p>
      </div>
    </div>
